...
class extract_data_area():
    ...
    def get_diff_histogram(self, args, ds1, ds2):
        ...
        #print('ds1 : ',ds1)
        ds1_id = ds1['id_area'].reset_index()
        #print('ds1_id : ',ds1_id)
        df_temp1 = ds1.iloc[:,2:].stack().reset_index()
        #print('df_temp1 : ',df_temp1)
        ...
        df_temp1_join = pd.merge(ds1_id, df_temp1, how = 'left', left_on = 'index', right_on = 'id')
        #print('df_temp1_join : ',df_temp1_join)
        
        #print('ds2 : ',ds2)
        ds2_id = ds2['id_area'].reset_index()
        #print('ds2_id : ',ds2_id)
        ...
        df_temp2_join = pd.merge(ds2_id, df_temp2, how = 'left', left_on = 'index', right_on = 'id')
        #print('df_temp2_join : ',df_temp2_join)

        # calculate difference
        df_join = pd.merge(df_temp1_join, df_temp2_join, how = 'inner', on = 'id_area')
        #print('df_join : ',df_join)
        df_join['diff'] = df_join['val1'] - df_join['val2']
        print('df_join[diff] : ',df_join['diff'])
