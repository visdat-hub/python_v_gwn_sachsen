...
class kliwes2_100_generator:
    def __init__(self, args):
        ...
        self.conf = {
            'parameters' : {
                ...
                'b' : {'src_id':8, 'tgt_id':39, 'decimals':2, 'dtype':'int32', 'nodata':-99999, 'to_hdf' : True, 'aggregation' : 'yearly_sum'},
                'ao' : {'src_id':9, 'tgt_id':37, 'decimals':2, 'dtype':'int32', 'nodata':-99999, 'to_hdf' : True, 'aggregation' : 'yearly_sum'},
    ...
    def create_parameter_by_scenarios(self, area_ds, x, y):
        ...
        scenario_id = self.args['param_id']
