...
class kliwes2_25_generator:
    def __init__(self, args):
        ...
        self.conf = {
            'parameters' : {
                'n' : {'src_id':1, 'tgt_id':10, 'decimals':2, 'dtype':'int32', 'nodata':-99999, 'to_hdf' : True, 'aggregation' : 'yearly_sum'},
                'nn' : {'src_id':2, 'tgt_id':35, 'decimals':2, 'dtype':'int32', 'nodata':-99999, 'to_hdf' : True, 'aggregation' : 'yearly_sum'},
                't' : {'src_id':3, 'tgt_id':9, 'decimals':2, 'dtype':'int32', 'nodata':-99999, 'to_hdf' : True, 'aggregation' : 'yearly_avg'},
                'rf' : {'src_id':4, 'tgt_id':40, 'decimals':2, 'dtype':'int32', 'nodata':-99999, 'to_hdf' : True, 'aggregation' : 'yearly_avg'},
                'etp' : {'src_id':5, 'tgt_id':8, 'decimals':2, 'dtype':'int32', 'nodata':-99999, 'to_hdf' : True, 'aggregation' : 'yearly_sum'},
                'kwb' : {'src_id':6, 'tgt_id':36, 'decimals':2, 'dtype':'int32', 'nodata':-99999, 'to_hdf' : True, 'aggregation' : 'yearly_sum'},
                'e' : {'src_id':7, 'tgt_id':31, 'decimals':2, 'dtype':'int32', 'nodata':-99999, 'to_hdf' : True, 'aggregation' : 'yearly_sum'},
                'ao' : {'src_id':8, 'tgt_id':39, 'decimals':2, 'dtype':'int32', 'nodata':-99999, 'to_hdf' : True, 'aggregation' : 'yearly_sum'},
                'bf' : {'src_id':9, 'tgt_id':37, 'decimals':2, 'dtype':'int32', 'nodata':-99999, 'to_hdf' : True, 'aggregation' : 'yearly_sum'},
                'hy' : {'src_id':10, 'tgt_id':25, 'decimals':2, 'dtype':'int32', 'nodata':-99999, 'to_hdf' : True, 'aggregation' : 'yearly_sum'},
                'r' : {'src_id':11, 'tgt_id':33, 'decimals':2, 'dtype':'int32', 'nodata':-99999, 'to_hdf' : True, 'aggregation' : 'yearly_sum'},
                'sw' : {'src_id':12, 'tgt_id':34, 'decimals':2, 'dtype':'int32', 'nodata':-99999, 'to_hdf' : True, 'aggregation' : 'yearly_sum'},
                'rg2' : {'src_id':13, 'tgt_id':12, 'decimals':2, 'dtype':'int32', 'nodata':-99999, 'to_hdf' : True, 'aggregation' : 'yearly_sum'},
                'rg1' : {'src_id':14, 'tgt_id':13, 'decimals':2, 'dtype':'int32', 'nodata':-99999, 'to_hdf' : True, 'aggregation' : 'yearly_sum'},
                'k' : {'src_id':16, 'tgt_id':38, 'decimals':2, 'dtype':'int32', 'nodata':-99999, 'to_hdf' : True, 'aggregation' : 'yearly_sum'},
    ...
    def create_parameter_by_scenarios(self, area_ds, x, y):
        ...
        print('--> current scenario',scenario_id)
        ...
        for p in self.conf['parameters']:
            ...
            if param_conf['tgt_id'] == int(self.args['param_id']):
                
                fpath = self.args['src_folder'] + str(param_conf['src_id']) + '/'
                print('--> fpath : ', fpath)
                #sys.exit()
