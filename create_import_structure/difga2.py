...
class difga2_import:
    def __init__(self, args):
        ...
        self.conf = {
            'parameters' : {
                'P' : {'id':10, 'decimals':2, 'dtype':'int32', 'to_hdf' : False},
                'RG2' : {'id':13, 'decimals':2, 'dtype':'int32', 'to_hdf' : False},
                'RG1' : {'id':12, 'decimals':2, 'dtype':'int32', 'to_hdf' : False},
                'RD' : {'id':16, 'decimals':2, 'dtype':'int32', 'to_hdf' : False},
                'QG2' : {'id':15, 'decimals':2, 'dtype':'int32', 'to_hdf' : False},
                'QG1' : {'id':14, 'decimals':2, 'dtype':'int32', 'to_hdf' : False},
                'REST' : {'id':31, 'decimals':2, 'dtype':'int32', 'to_hdf' : False},
                'DEF' : {'id':18, 'decimals':2, 'dtype':'int32', 'to_hdf' : False}
            },
            'derived_parameters' : {
                ...
                'sicker' : {'id':34, 'decimals':2, 'dtype':'int32', 'to_hdf' : False}
            }
        }
